...
# Train model (without generator, with class_weight)
model.fit(
...
model.save(os.path.join("saved_models", "pokemon_classifier_class_weights.keras"))

# Save label encoder
with open("saved_models/label_encoder_class_weights.pkl", "wb") as f:
